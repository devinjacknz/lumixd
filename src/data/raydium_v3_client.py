...
class RaydiumV3Client:
    def __init__(self):
        self.api_url = "https://api.raydium.io/v3"
...
raydium_v3_client = RaydiumV3Client()  # Singleton instance
