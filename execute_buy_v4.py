...
from src.data.raydium_client import raydium_client
...
async def execute_buy() -> None:
    """Execute buy trade for VINE token using Raydium"""
    try:
        # Parameters for Raydium API
        input_mint = SOL_MINT
        ...
        # Get quote
        quote = await raydium_client.get_quote(
        ...
        signature = await raydium_client.execute_swap(quote, wallet_key)
